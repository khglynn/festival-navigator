// The made-up crew for the one-river frames (2026-09-26; copied from ../../people-shelf/crew.mjs,
// plus Sunday picks at 2 PM on both sides of town and two day notes). Before: the people-menu crew (2026-09-25; copied from the OURS round). Placeholder
...
export const SELECTIONS = {
  ...
  // ---- Sunday at 2 PM: the fork (one-river round) — Pier 80's openers vs
  //      the fair and its day parties
  'Torren Foot': P({ Ana: 2, Ivy: 2 }),
  'Mind Enterprises': P({ Ana: 3, Cy: 2, Ivy: 2 }),
  'Azzecca': P({ Ben: 2 }),
  'Clearcast': P({ Eli: 1 }),
  'AIRTIGHT': P({ Cy: 3, Fay: 2 }),
  'BOOF presents MCMLXXXV (Herrensauna)': P({ Gus: 3, Eli: 2, Ana: 2 }),
  'Party On The Plaza: Folsom Edition': P({ Dot: 2 }),
  'CUMUNION - FOLSOM EDITION': P({ Hal: 2 }),
  'Hot Tea - Leather Edition': P({ Fay: 3 }),
...
export function crewDoc(fid = 'portola-2026', n = 9) {
  return {
    ...
    festivals: { [fid]: { selections: selectionsFor(n), notes: NOTES } },
  };
}

// Two day notes, written where the writer stood (MODEL-V4 §3a.3): one on
// Sunday's DATE (the Portola door), one on Folsom-on-Sunday.
const NOTES = {
  day: {
    '2026-09-27': { n_ana_1: { author: 'Ana', text: 'Mind Enterprises 2:30 then Channel Tres, same stage', ts: '2026-09-26T17:02:00Z' } },
    '2026-09-27|Folsom': { n_dot_1: { author: 'Dot', text: 'Fair from noon, meet by the Eagle, Pier 80 by 3?', ts: '2026-09-26T18:40:00Z' } },
  },
};
