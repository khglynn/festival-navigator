// The made-up crew for the moment-lens frames (2026-09-26; copied from ../people-shelf/crew.mjs,
// Sunday tuned so 'Sunday at 2 — Folsom or Portola?' is a real fork).
// Original header: The made-up crew for the people-menu frames (2026-09-25; copied from the OURS round). Placeholder
...
export const SELECTIONS = {
  ...
  // ---- Sunday, Folsom Street Fair vs Pier 80 (tuned for the moment lens)
  'Folsom Street Fair': P({ Cy: 4, Dot: 3, Fay: 3, Hal: 2 }),
  'BOOF presents MCMLXXXV (Herrensauna)': P({ Gus: 3, Eli: 2 }),
  'Party On The Plaza: Folsom Edition': P({ Dot: 1 }),
  'Torren Foot': P({ Ana: 2, Ivy: 2 }),
  'Clearcast': P({ Ben: 1 }),
  'Dean Turnley': P({ Ben: 2 }),
