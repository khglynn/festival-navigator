> **History, not state.** NOW.md as it stood on `events-ui` at e9a30bb (last written 2026-09-02), moved here verbatim on 2026-09-16 when NOW.md went back to being a one-screen cursor.
> Nothing below is current. Where things stand: NOW.md. The dated story: DEVLOG.md.
