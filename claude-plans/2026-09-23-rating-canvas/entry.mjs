...
// runtime.js does, through these exports only.
...
import portola from '../../data/festivals/portola-2026.json';
import festIndex from '../../data/festivals/index.json';

globalThis.FN = { state, FESTIVALS, FESTIVAL_INDEX, wall, facts, model, aura, palette, motion, portola, festIndex };
